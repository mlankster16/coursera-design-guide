...
/** CTL asked for every rung of the worked-example hierarchy chain to read as
    a title; the design leaves the first two at regular weight. */
const boldChainTitles = (s) => s.replace(
